...
var _chunkEYIGSKY4js = require('./chunk-EYIGSKY4.js');
...
function babelParse(code, lang, options = {}) {
  const plugins = [];
  if (lang) {
    if (_chunkEYIGSKY4js.isTs.call(void 0, lang))
      plugins.push("typescript");
    if (_chunkUDPJYA4Djs.REGEX_JSX_FILE.test(lang))
      plugins.push("jsx");
  }
